...
final class load$minusivy$_ {
def args = load$minusivy_sc.args$
def scriptPath = """source/load-ivy.sc"""
/*<script>*/
...
object load$minusivy_sc {
  ...
  lazy val script = new load$minusivy$_
...
export load$minusivy_sc.script as `load-ivy`
